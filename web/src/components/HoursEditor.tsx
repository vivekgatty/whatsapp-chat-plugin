        ...
        return (
          <div key={day} className="grid grid-cols-[60px_1fr_1fr_1fr] items-center gap-3 px-4 py-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-zinc-400 w-8">From</span>
              <select
                disabled={cfg.holiday}
                className="w-36 rounded-md bg-zinc-900 border border-zinc-700 px-2 py-1.5"
                value={cfg.from}
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-zinc-400 w-6">To</span>
              <select
                disabled={cfg.holiday}
                className="w-36 rounded-md bg-zinc-900 border border-zinc-700 px-2 py-1.5"
                value={cfg.to}
