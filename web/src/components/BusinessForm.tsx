    ...
    <form action={action} className="space-y-6">
      ...
      <div className="grid gap-4">
        <label className="text-sm">
          <span className="mb-1 block text-zinc-400">Business / company name</span>
          <input
            name="name"
        ...
        <label className="text-sm">
          <span className="mb-1 block text-zinc-400">Category</span>
          <input
            name="category"
        ...
        <div className="text-sm">
          <span className="mb-1 block text-zinc-400">WhatsApp number (E.164)</span>
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="flex-1 rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 outline-none"
            />
          </div>
          <p className="mt-1 text-xs text-zinc-500">
            We’ll store the full E.164 as{" "}
            <code>
              {cc}
              {num ? " " + num : ""}
            </code>
        ...
        <label className="text-sm">
          <span className="mb-1 block text-zinc-400">Contact name</span>
          <input
            name="contact_name"
        ...
        <label className="text-sm">
          <span className="mb-1 block text-zinc-400">Timezone</span>
          <select
            name="timezone"
        ...
        <div className="text-sm">
          <span className="mb-2 block text-zinc-400">Working hours</span>
          <HoursEditor value={initial.hours ?? undefined} onChange={setHours} />
          <p className="mt-2 text-xs text-zinc-500">
            Choose hours in 12-hour format or mark a day as Holiday.
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <a href="/dashboard" className="rounded-md border border-zinc-600 px-4 py-2">
          Cancel
        </a>
      </div>
    </form>
