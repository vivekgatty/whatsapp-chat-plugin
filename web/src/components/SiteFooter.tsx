    ...
    <footer className="mt-12 w-full border-t border-slate-800">
      <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-3 px-4 py-6 text-sm sm:flex-row">
        ...
        <nav className="flex gap-4">
          <a className="text-slate-300 underline hover:text-white" href="/privacy-policy">
            Privacy Policy
          </a>
          <a className="text-slate-300 underline hover:text-white" href="/terms-and-conditions">
            Terms & Conditions
          </a>
          <a className="text-slate-300 underline hover:text-white" href="/cancellations-and-refunds">
