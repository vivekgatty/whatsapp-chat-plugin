...
export default function BusinessProfileView() {
  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      {err && <div className="text-red-400 text-sm mb-4">Error: {err}</div>}

      {!data ? (
        <div className="rounded border px-4 py-3">
          <p className="text-green-400 text-sm mb-2">Signed in as {email}.</p>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded border px-4 py-3">
            <div className="text-sm font-medium mb-3">Working hours</div>
            {!wh ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {(['mon','tue','wed','thu','fri','sat','sun'] as DayKey[]).map((d) => {
                  ...
                  const line = v
                    ...
                    : '—';
                  return (
                    <div key={d} className="flex justify-between border rounded px-3 py-2">
