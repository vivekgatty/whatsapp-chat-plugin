...
export const metadata: Metadata = { title: "Cancellations & Refunds â€” Chatmadi" };
  ...
  return (
    <div className="mx-auto max-w-4xl p-4 md:p-8 space-y-6">
      ...
      <ul className="list-disc ps-6 space-y-2">
        ...
        <li><strong>First-time purchase issue</strong>: if a technical problem prevents meaningful use and you contact us within 7 days, weâ€™ll resolve or refund in good faith.</li>
      ...
      <p>Approved refunds are issued to the original payment method via Razorpay. Bank/card timelines typically 5â€“10 business days after approval.</p>
      ...
      <p>Email <a className="underline" href="mailto:admin@chatmadi.com">admin@chatmadi.com</a> with your account email, payment reference, and details.</p>
    </div>
  );
}