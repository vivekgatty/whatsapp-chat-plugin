...
export default function Home() {
  ...
  return (
    <main className="px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-slate-300">
              ...
              <Link href="/docs/templates" className="underline">multilingual templates</Link>,{" "}
              <Link href="/docs/dashboard#business-hours" className="underline">off-hours auto-replies</Link>, and{" "}
              <Link href="/docs/analytics" className="underline">built-in analytics</Link>. No bloat. No hassle.{" "}
            ...
            <ul className="mt-6 grid gap-2 text-slate-200 sm:grid-cols-2">
              <DotItem>Copy–paste install for WordPress, Webflow, Shopify, Wix, Squarespace, Next.js, or plain HTML. See the <Link href="/docs/install" className="underline">Install Guide</Link>.</DotItem>
              <DotItem>Precision control with <Link href="/docs/templates" className="underline">Templates</Link>, <Link href="/docs/languages" className="underline">Languages</Link>, and <Link href="/docs/dashboard#business-hours" className="underline">Business Hours</Link>.</DotItem>
              <DotItem>Privacy-friendly, fast, and accessible. Read the <Link href="/docs/troubleshooting#performance" className="underline">performance tips</Link>.</DotItem>
              <DotItem>Built-in <Link href="/docs/analytics" className="underline">Analytics</Link>: impressions, opens, clicks — no extra setup.</DotItem>
            </ul>
          </div>
      ...
      {/* SOCIAL PROOF / BADGES (lightweight, text-only for speed) */}
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          <div className="rounded-xl border border-slate-700 p-5">
            ...
            <p className="mt-2 text-slate-300">
              Copy the embed code from <Link href="/dashboard/widgets" className="underline">Widget settings</Link> or follow the{" "}
              <Link href="/docs/install" className="underline">Install Guide</Link>. Paste it before{" "}
          ...
          <div className="rounded-xl border border-slate-700 p-5">
            ...
            <p className="mt-2 text-slate-300">
              Create <Link href="/docs/templates" className="underline">Templates</Link> for greetings & off-hours. Set{" "}
              <Link href="/docs/languages" className="underline">Languages</Link> and{" "}
              <Link href="/docs/dashboard#business-hours" className="underline">Business Hours</Link>.
            </p>
          </div>
          <div className="rounded-xl border border-slate-700 p-5">
            ...
            <p className="mt-2 text-slate-300">
              Use <Link href="/docs/analytics" className="underline">Analytics</Link> to track impressions, opens, and clicks. Iterate on copy, timing, and triggers.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-xl border border-slate-700 p-5">
            ...
            <ul className="mt-2 space-y-2 text-slate-300">
              <DotItem>Auto-select locale with smart fallbacks. Details in <Link href="/docs/languages" className="underline">Languages</Link>.</DotItem>
              <DotItem>Configure Mon–Sat windows, Sunday closed, and holidays. See <Link href="/docs/dashboard#business-hours" className="underline">Business Hours</Link>.</DotItem>
            </ul>
          </div>
          <div className="rounded-xl border border-slate-700 p-5">
            <h3 className="font-medium">Copy–paste developer experience</h3>
            <ul className="mt-2 space-y-2 text-slate-300">
              <DotItem>Embed + auto-trigger buttons in <Link href="/dashboard/widgets" className="underline">Widget settings</Link>.</DotItem>
              <DotItem>Production tips: CSP, placement, QA checks — <Link href="/docs/troubleshooting" className="underline">Troubleshooting</Link>.</DotItem>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-sky-700 bg-sky-950/30 p-6 md:col-span-2">
            ...
            <p className="mt-2 text-xs text-slate-400">
              ...
              <Link href="/docs/faq#billing" className="underline">Billing FAQ</Link>.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-700 p-6">
            ...
            <div className="mt-6">
              <Link href="/docs/faq#billing" className="rounded-xl border border-slate-700 px-5 py-3 text-sm hover:bg-slate-800">
                Learn more
              </Link>
            </div>
          </div>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-700 p-5">
            ...
            <ul className="mt-2 space-y-2 text-slate-300">
              ...
              <DotItem>Use <Link href="/docs/templates" className="underline">Template</Link> variants to A/B test greeting copy.</DotItem>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="cta" className="mx-auto mt-16 max-w-6xl">
        <div className="rounded-2xl border border-slate-700 p-6 text-center">
          ...
          <p className="mt-2 text-slate-300">
            ...
            Need help? Read the <Link href="/docs" className="underline">Docs</Link> or the{" "}
