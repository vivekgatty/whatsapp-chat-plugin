...
function DaysLink({ d, current }: { d: number; current: number }) {
  ...
  return (
    <Link href={`?days=${d}`} className={cls}>
      {d === 1 ? "Today" : `${d} days`}
    </Link>
  );
}
    ...
    <div className="space-y-6 p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard"
            className="rounded border border-slate-700 bg-slate-800 px-3 py-1 text-slate-200"
          >
            ← Back to Dashboard
          </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            className="ml-2 rounded border border-slate-700 bg-slate-800 px-3 py-1"
      ...
      <div className="rounded border border-slate-700 bg-slate-900/50 p-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold">
            Totals (last {days} {days === 1 ? "day" : "days"})
          </h2>
