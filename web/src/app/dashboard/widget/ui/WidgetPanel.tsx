...
export default function WidgetPanel(
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      <div className="rounded-xl border border-zinc-700 p-4 space-y-4">
        <div>
          <span className="text-sm text-zinc-300">Theme color</span>
        <div className="mt-1 flex items-center gap-3">
            <input type="color" value={row.theme_color}
              onChange={e=>setRow(r=>({ ...r, theme_color: e.target.value }))} />
            <input className="flex-1 rounded-md bg-zinc-900 border border-zinc-700 px-3 py-2"
              value={row.theme_color} onChange={e=>setRow(r=>({ ...r, theme_color: e.target.value }))}/>
          </div>
        </div>
        ...
        <label className="block">
          ...
          <textarea className="mt-1 w-full rounded-md bg-zinc-900 border border-zinc-700 px-3 py-2"
                    rows={3}
      ...
      <div className="rounded-xl border border-zinc-700 p-4">
        <p className="text-sm text-zinc-400 mb-2">Live preview</p>
        <div className="rounded-lg bg-zinc-950 border border-zinc-800 p-6 min-h-[220px] flex items-end justify-end">
          <button
        ...
        <p className="text-sm text-zinc-400 mt-4 mb-1">Embed snippet</p>
        <textarea className="w-full rounded-md bg-zinc-900 border border-zinc-700 px-3 py-2"
                  rows={3} readOnly value={embed}/>
      </div>
    </div>
  );
}
