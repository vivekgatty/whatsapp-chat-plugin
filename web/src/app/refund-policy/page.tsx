...
export default function Page() {
  return (
    <div className="prose prose-invert mx-auto max-w-5xl px-4 py-10">
      ...
      <p>
        You can cancel anytime from your dashboard. Access remains until the end of the current
        billing period.
      </p>
      <h2>Refunds</h2>
      <p>
        If you believe you were charged in error, contact us within 7 days of the charge at
        <a href="mailto:admin@chatmadi.com"> admin@chatmadi.com</a>. Approved refunds are processed
